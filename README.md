...
| -------- | ---------------------------------------------- | ---------------- | --------------------------------------------------- |
| 生命     | 玩家的生命值加成。                             | 生命值 +2        | 无                                                  |
| 减肥     | 减小玩家的大小到初始值的一半，但不小于最小值。 | 玩家大小减半     | 无                                                  |
| 移速+5   | 增加玩家的移动速度。                           | 移动速度 +5      | 如玩家强大，大小 +5                                 |
| 移速+20  | 大幅增加玩家的移动速度。                       | 移动速度 +20     | 如玩家强大，大小 +20                                |
| 刀数     | 增加玩家的旋刃数量。                           | 旋刃数量 +1      | 如玩家强大，大小 +10，移动速度 -10，旋刃旋转速度 -2 |
| 刀数+3   | 大幅增加玩家的旋刃数量。                       | 旋刃数量 +3      | 如玩家强大，大小 +30，移动速度 -20，旋刃旋转速度 -5 |
| 刀长+5   | 增加玩家旋刃的长度。                           | 旋刃长度 +5      | 无                                                  |
| 刀长+20  | 大幅增加玩家旋刃的长度。                       | 旋刃长度 +20     | 如玩家强大，大小 +30，移动速度 -20，旋刃旋转速度 -5 |
| 刀伤     | 增加玩家旋刃的伤害值。                         | 旋刃伤害 +1      | 无                                                  |
| 刀速+5   | 增加玩家旋刃的旋转速度。                       | 旋刃旋转速度 +5  | 如玩家强大，大小 +10，移动速度 -10                  |
| 刀速+20  | 大幅增加玩家旋刃的旋转速度。                   | 旋刃旋转速度 +20 | 如玩家强大，大小 +30，移动速度 -20                  |
| 随机     | 随机给予玩家一个奖励。                         | 随机一个奖励     | 取决于随机奖励的负面效果                            |
